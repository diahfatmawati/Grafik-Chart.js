...
<html>
<head>
	<title> Pie Chart Perbandingan COVID-19 di 10 Negara </title>
	<script type="text/javascript" src="Chart.js"></script>
	<style type="text/css">
		.main{
			background-color: rgba(254, 239, 213, 0.6);}
		.main1{
			padding-left: 80%;}
		.h1{
...
<body class="main">
	<br><h1 class="h1"> Pie Chart Perbandingan COVID-19 di 10 Negara </h1><br>
