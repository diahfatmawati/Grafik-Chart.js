...
<html>
<head>
	<title> Bar Chart Perbandingan COVID-19 di 10 Negara </title>
	<script type="text/javascript" src="Chart.js"></script>
	<style type="text/css">
		.main{
			background-color: rgba(143, 188, 144, 0.3);
		}
		.main1{
			padding-left: 61%;
		}
...
<body class="main">
	<br><h1 class="h1"> Bar Chart Perbandingan COVID-19 di 10 Negara </h1><br><br>
